...
=== Representation of an authentication device

WebAuthn4j provides `Authenticator` interface as a representation of an authentication device (aka authenticator). 
