...
https://www.w3.org/TR/secure-payment-confirmation/[W3C Secure Payment Confirmation (SPC)] のサーバーサイド検証機能を提供します。
...
|`JsonMapper` 上のJackson Module

|Authenticator Extension Output
|`ExtensionAuthenticatorOutputDeserializer`
|`CBORMapper` 上のJackson Module
