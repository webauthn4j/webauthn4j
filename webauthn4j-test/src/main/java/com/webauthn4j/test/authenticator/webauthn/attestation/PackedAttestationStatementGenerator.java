...
public class PackedAttestationStatementGenerator {

    public AttestationStatement generate(byte[] signature, AttestationCertificatePath attestationCertificatePath){
