...
class MultipleAttestationVerifierTest {
    ...
    private final PackedAttestationStatementReactiveVerifier packedAttestationStatementReactiveVerifier = new PackedAttestationStatementReactiveVerifier();
    private final NoneAttestationStatementReactiveVerifier noneAttestationStatementReactiveVerifier = new NoneAttestationStatementReactiveVerifier();
    private final WebAuthnReactiveManager webAuthnReactiveManager = new WebAuthnReactiveManager(Lists.list(packedAttestationStatementReactiveVerifier, noneAttestationStatementReactiveVerifier), new DefaultCertPathTrustworthinessReactiveVerifier(trustAnchorReactiveRepository), new DefaultSelfAttestationTrustworthinessReactiveVerifier());
