...
class DeviceCheckAttestationManagerTest {
    ...
    void validate_test(){
        ...
        DeviceCheckAttestationManager deviceCheckAttestationManager = new DeviceCheckAttestationManager(new TrustAnchorCertPathTrustworthinessValidator(trustAnchorsResolver), Collections.emptyList(), objectConverter);
