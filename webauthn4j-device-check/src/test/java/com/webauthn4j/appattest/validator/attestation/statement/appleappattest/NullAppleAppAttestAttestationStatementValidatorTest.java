...
class NullAppleAppAttestAttestationStatementValidatorTest {

    private final NullAppleAppAttestAttestationStatementValidator target = new NullAppleAppAttestAttestationStatementValidator();
