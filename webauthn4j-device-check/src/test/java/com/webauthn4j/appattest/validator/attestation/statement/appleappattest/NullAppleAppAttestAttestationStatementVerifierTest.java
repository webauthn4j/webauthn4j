...
class NullAppleAppAttestAttestationStatementVerifierTest {

    private final NullAppleAppAttestAttestationStatementVerifier target = new NullAppleAppAttestAttestationStatementVerifier();
