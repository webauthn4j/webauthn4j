 ...
 */
@SpringBootTest(classes = {WebSecurityConfig.class, DomainConfig.class, InfrastructureMockConfig.class, ModelMapperAppConfig.class})
@RunWith(SpringJUnit4ClassRunner.class)
public class ProfileUpdateFormToUserConverterTest {
