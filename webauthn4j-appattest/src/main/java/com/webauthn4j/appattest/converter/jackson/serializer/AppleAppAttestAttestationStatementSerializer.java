...
public class AppleAppAttestAttestationStatementSerializer extends AbstractCtapCanonicalCborSerializer<AppleAppAttestAttestationStatement> {
    ...
    public AppleAppAttestAttestationStatementSerializer() {
        super(AppleAppAttestAttestationStatement.class, Arrays.asList(
                new FieldSerializationRule<>("x5c", AppleAppAttestAttestationStatement::getX5c),
                new FieldSerializationRule<>("receipt", AppleAppAttestAttestationStatement::getReceipt)
        ));
    }
}
