...
class FidoMdsMetadataItemsProviderTest {
    ...
    @Test
    void appendToken() {
        Assertions.assertThat(FidoMdsMetadataItemsProvider.appendToken("https://mds2.fidoalliance.org/", "dummyToken")).isEqualTo("https://mds2.fidoalliance.org/?token=dummyToken");
