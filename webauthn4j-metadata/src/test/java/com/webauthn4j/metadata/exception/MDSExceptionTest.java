...
class MDSExceptionTest {

    private final RuntimeException cause = new RuntimeException();

    @Test
    void test() {
        MDSException exception1 = new MDSException("dummy", cause);
        MDSException exception2 = new MDSException("dummy");
        MDSException exception3 = new MDSException(cause);
