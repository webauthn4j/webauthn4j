...
class UnknownProtocolFamilyExceptionTest {
    ...
    @Test
    void test() {
        UnknownProtocolFamilyException exception1 = new UnknownProtocolFamilyException("dummy", cause);
        UnknownProtocolFamilyException exception2 = new UnknownProtocolFamilyException("dummy");
        UnknownProtocolFamilyException exception3 = new UnknownProtocolFamilyException(cause);
