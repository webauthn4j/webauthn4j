...
class BadStatusExceptionTest {

    private final RuntimeException cause = new RuntimeException();

    @Test
    void test() {
        BadStatusException exception1 = new BadStatusException("dummy", cause);
        BadStatusException exception2 = new BadStatusException("dummy");
        BadStatusException exception3 = new BadStatusException(cause);
