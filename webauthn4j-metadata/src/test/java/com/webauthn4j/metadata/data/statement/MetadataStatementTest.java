...
class MetadataStatementTest {
    ...
    void test(){
        ...
        assertThat(metadataStatement.getMultiDeviceCredentialSupport()).isEqualTo(MultiDeviceCredentialSupport.EXPLICIT);
        assertThat(metadataStatement.getCxConfigURL()).isEqualTo("https://example.com/cxconfig");
    ...
    private MetadataStatement createMetadataStatement(){
        String metadataStatementString = "{\n" +
                ...
                "        ],\n" +
                "        \"iconDark\": \"data:image/png;base64,darkicon\",\n" +
                "        \"providerLogoLight\": \"data:image/png;base64,lightlogo\",\n" +
                "        \"providerLogoDark\": \"data:image/png;base64,darklogo\",\n" +
                "        \"multiDeviceCredentialSupport\": \"explicit\",\n" +
                "        \"cxConfigURL\": \"https://example.com/cxconfig\",\n" +
