...
class UserVerifyingAuthenticatorAuthenticationValidationReactiveTest {
    ...
    private final WebAuthnReactiveManager target = WebAuthnReactiveManager.createNonStrictWebAuthnReactiveManager(objectConverter);
