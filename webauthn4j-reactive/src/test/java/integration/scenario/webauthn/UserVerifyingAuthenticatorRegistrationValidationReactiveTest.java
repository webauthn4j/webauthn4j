...
class UserVerifyingAuthenticatorRegistrationValidationReactiveTest {
    ...
    private final WebAuthnReactiveManager target = WebAuthnReactiveManager.createNonStrictWebAuthnReactiveManager();

    private final AuthenticationExtensionsClientOutputsConverter authenticationExtensionsClientOutputsConverter
            = new AuthenticationExtensionsClientOutputsConverter(objectConverter);

    @Test
    void verify_RegistrationRequest_with_none_attestation_statement_test() throws ExecutionException, InterruptedException {
        ...
        assertThatCode(()-> target.verify(webAuthnRegistrationRequest, registrationParameters).toCompletableFuture().get()).doesNotThrowAnyException();
    }
}
