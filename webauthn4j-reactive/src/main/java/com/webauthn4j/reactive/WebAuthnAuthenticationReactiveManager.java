...
public class WebAuthnAuthenticationReactiveManager {
    ...
    private final AuthenticationDataReactiveVerifier authenticationDataReactiveVerifier;

    public WebAuthnAuthenticationReactiveManager(
        ...
        authenticationDataReactiveVerifier = new AuthenticationDataReactiveVerifier(customAuthenticationReactiveVerifiers);
    ...
    public WebAuthnAuthenticationReactiveManager(
            @NotNull List<CustomAuthenticationReactiveVerifier> customAuthenticationVerifiers) {
    ...
    public @NotNull CompletionStage<AuthenticationData> verify(
        ...
        return authenticationDataReactiveVerifier.verify(authenticationData, authenticationParameters);
    }

    public @NotNull AuthenticationDataReactiveVerifier getAuthenticationDataReactiveVerifier() {
        return authenticationDataReactiveVerifier;
    }
}
