...
public class RegistrationDataReactiveVerifier {
    ...
    private final List<CustomRegistrationReactiveVerifier> customRegistrationReactiveVerifiers;

    private final AttestationReactiveVerifier attestationReactiveVerifier;

    private OriginReactiveVerifier originVerifier = new OriginReactiveVerifierImpl();

    private int maxCredentialIdLength = DEFAULT_MAX_CREDENTIAL_ID_LENGTH;

    public RegistrationDataReactiveVerifier(
            List<AttestationStatementReactiveVerifier> attestationStatementReactiveVerifiers,
            CertPathTrustworthinessReactiveVerifier certPathTrustworthinessReactiveVerifier,
            SelfAttestationTrustworthinessReactiveVerifier selfAttestationTrustworthinessReactiveVerifier,
            List<CustomRegistrationReactiveVerifier> customRegistrationReactiveVerifiers, ObjectConverter objectConverter) {
        ...
        this.attestationReactiveVerifier = new AttestationReactiveVerifier(
        ...
        this.customRegistrationReactiveVerifiers = customRegistrationReactiveVerifiers;
    }
    ...
    private class RegistrationDataVerification{
        ...
        public CompletionStage<RegistrationData> execute(){
            return execStep1toStep8()
                    .thenCompose((__)-> this.execStep9())
                    .thenCompose((__)-> this.execStep10toStep19())
                    .thenCompose((__)-> this.execStep20())
                    .thenCompose((__)-> this.execStep21toStep24AndStep28())
                    .thenCompose((__)-> this.execStep25toStep27())
                    .thenApply((__)-> registrationData);
        }
        ...
        private CompletionStage<Void> execStep20(){
            ...
            return clientExtensionReactiveVerifier.verify(clientExtensions).thenCompose((__)-> authenticatorExtensionReactiveVerifier.verify(authenticatorExtensions));
        }
        ...
        private CompletionStage<Void> execStep21toStep24AndStep28(){
            ...
            return attestationReactiveVerifier.verify(registrationObject);
        }
        ...
        private CompletionStage<Void> execStep25toStep27(){
            ...
            Iterator<CustomRegistrationReactiveVerifier> iterator = customRegistrationReactiveVerifiers.iterator();
            CompletableFuture<Void> completableFuture = CompletableFuture.completedFuture(null);
            while(iterator.hasNext()){
                CustomRegistrationReactiveVerifier customRegistrationReactiveVerifier = iterator.next();
                completableFuture = completableFuture.thenAccept((______void)-> customRegistrationReactiveVerifier.verify(registrationObject));
            }
            return CompletableFuture.completedFuture(null);
        }
    }
