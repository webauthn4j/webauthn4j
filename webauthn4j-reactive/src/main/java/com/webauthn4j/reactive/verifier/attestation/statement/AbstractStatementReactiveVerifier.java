...
public abstract class AbstractStatementReactiveVerifier<T extends AttestationStatement> implements AttestationStatementReactiveVerifier {

    private final Class<?> parameterizedTypeClass;

    protected AbstractStatementReactiveVerifier() {
