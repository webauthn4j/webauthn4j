...
class HMACCreateSecretExtensionAuthenticatorOutputTest {

    @Test
    void getIdentifier_test(){
        HMACCreateSecretExtensionAuthenticatorOutput target = new HMACCreateSecretExtensionAuthenticatorOutput(true);
        assertThat(target.getIdentifier()).isEqualTo(HMACCreateSecretExtensionAuthenticatorOutput.ID);
    }
    ...
    void validate_invalid_data_test(){
        HMACCreateSecretExtensionAuthenticatorOutput target = new HMACCreateSecretExtensionAuthenticatorOutput(null);
