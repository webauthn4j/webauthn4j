...
class HMACCreateSecretExtensionClientOutputTest {

    @Test
    void getValue_test(){
        HMACCreateSecretExtensionClientOutput target = new HMACCreateSecretExtensionClientOutput(true);
    ...
    void validate_invalid_data_test(){
        HMACCreateSecretExtensionClientOutput target = new HMACCreateSecretExtensionClientOutput(null);
