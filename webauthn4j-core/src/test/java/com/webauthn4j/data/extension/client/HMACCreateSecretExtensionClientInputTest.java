...
class HMACCreateSecretExtensionClientInputTest {

    @Test
    void getValue_test(){
        HMACCreateSecretExtensionClientInput target = new HMACCreateSecretExtensionClientInput(true);
    ...
    void validate_invalid_data_test(){
        HMACCreateSecretExtensionClientInput target = new HMACCreateSecretExtensionClientInput(null);
