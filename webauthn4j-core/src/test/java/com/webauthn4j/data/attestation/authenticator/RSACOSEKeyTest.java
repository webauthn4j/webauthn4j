...
class RSACOSEKeyTest {
    ...
    void create_with_alg_test() {
        ...
        // When
        RSACOSEKey key1 = RSACOSEKey.create((RSAPrivateKey) keyPair.getPrivate(), COSEAlgorithmIdentifier.RS256);
        RSACOSEKey key2 = RSACOSEKey.create((RSAPublicKey) keyPair.getPublic(), COSEAlgorithmIdentifier.RS256);
        RSACOSEKey key3 = RSACOSEKey.create(keyPair, COSEAlgorithmIdentifier.RS256);

        // Then
        assertThat(key1.getAlgorithm()).isEqualTo(COSEAlgorithmIdentifier.RS256);
        assertThat(key2.getAlgorithm()).isEqualTo(COSEAlgorithmIdentifier.RS256);
        assertThat(key3.getAlgorithm()).isEqualTo(COSEAlgorithmIdentifier.RS256);
    }
    ...
    void toString_test(){
        // Given
        byte[] encoded = HexUtil.decode("");

        // When
        RSACOSEKey coseKey = cborMapper.readValue(encoded, RSACOSEKey.class);
