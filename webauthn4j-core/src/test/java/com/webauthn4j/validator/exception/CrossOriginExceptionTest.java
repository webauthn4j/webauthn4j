...
class CrossOriginExceptionTest {

    private final RuntimeException cause = new RuntimeException();

    @Test
    void test() {
        CrossOriginException exception1 = new CrossOriginException("dummy", cause);
        CrossOriginException exception2 = new CrossOriginException("dummy");
        CrossOriginException exception3 = new CrossOriginException(cause);
