...
class UserNotVerifiedExceptionTest {
    ...
    @Test
    void test() {
        UserNotVerifiedException exception1 = new UserNotVerifiedException("dummy", cause);
        UserNotVerifiedException exception2 = new UserNotVerifiedException("dummy");
        UserNotVerifiedException exception3 = new UserNotVerifiedException(cause);
