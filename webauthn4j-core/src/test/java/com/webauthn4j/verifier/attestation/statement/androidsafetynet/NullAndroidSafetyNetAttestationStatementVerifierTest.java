...
class NullAndroidSafetyNetAttestationStatementVerifierTest {

    private final NullAndroidSafetyNetAttestationStatementVerifier target = new NullAndroidSafetyNetAttestationStatementVerifier();
