...
class NullSelfAttestationTrustworthinessVerifierTest {

    private final NullSelfAttestationTrustworthinessVerifier validator = new NullSelfAttestationTrustworthinessVerifier();
