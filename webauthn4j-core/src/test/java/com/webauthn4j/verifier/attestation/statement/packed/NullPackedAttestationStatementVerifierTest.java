...
class NullPackedAttestationStatementVerifierTest {

    private final NullPackedAttestationStatementVerifier target = new NullPackedAttestationStatementVerifier();
    ...
    @Test
    void verify_non_PackedAttestation_test() {
