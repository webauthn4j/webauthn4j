...
class AppleAnonymousAttestationStatementVerifierTest {

    private final AppleAnonymousAttestationStatementVerifier target = new AppleAnonymousAttestationStatementVerifier();

    @Test
    void verify_test() {
        CoreRegistrationObject coreRegistrationObject = TestDataUtil.createRegistrationObjectWithAppleAttestation();
        target.verify(coreRegistrationObject);
    }
