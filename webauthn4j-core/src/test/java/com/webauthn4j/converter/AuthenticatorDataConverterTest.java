...
public class AuthenticatorDataConverterTest {
    ...
    public void convert_test() {
        ...
        //When
        AuthenticatorData result = new AuthenticatorDataConverter(registry.getJsonMapper()).convert(Base64UrlUtil.decode(input));
    ...
    public void convert_too_short_data_test() {
        ...
        //When
        new AuthenticatorDataConverter(registry.getJsonMapper()).convert(Base64UrlUtil.decode(input));
    }
    ...
    public void serialize_deserialize_test() {
        ...
        //When
        byte[] serialized = new AuthenticatorDataConverter(registry.getJsonMapper()).convert(authenticatorData);
        AuthenticatorData result = new AuthenticatorDataConverter(registry.getJsonMapper()).convert(serialized);
    ...
    public void deserialize_data_with_surplus_bytes_test() {
        ...
        //When
        new AuthenticatorDataConverter(registry.getJsonMapper()).convert(bytes);
    }
}
