...
public class PublicKeyCredentialCreationOptions {
    ...
    private final List<PublicKeyCredentialDescriptor> excludeCredentials;
        ...
        public PublicKeyCredentialCreationOptions(
                ...
                @Nullable @JsonProperty("attestationFormats") List<String> attestationFormats,
            ...
            this.attestationFormats = CollectionUtil.unmodifiableList(attestationFormats);
        ...
        public PublicKeyCredentialCreationOptions(
                ...
                @Nullable List<PublicKeyCredentialHints> hints,
            ...
            this(rp, user, challenge, pubKeyCredParams, timeout, excludeCredentials, authenticatorSelection, hints, attestation, null, extensions);
        }
        ...
        public PublicKeyCredentialCreationOptions(
                ...
                @Nullable AttestationConveyancePreference attestation,
                @Nullable AuthenticationExtensionsClientInputs<RegistrationExtensionClientInput> extensions) {
            this(rp, user, challenge, pubKeyCredParams, timeout, excludeCredentials, authenticatorSelection, null, attestation, null, extensions);
        }
        ...
        public PublicKeyCredentialCreationOptions(
                ...
                @NotNull Challenge challenge,
                @NotNull List<PublicKeyCredentialParameters> pubKeyCredParams) {
            this(rp, user, challenge, pubKeyCredParams, null, Collections.emptyList(), null, null, null, null, null);
        }
        ...
        @Override
        public int hashCode() {
            return Objects.hash(rp, user, challenge, pubKeyCredParams, timeout, excludeCredentials, authenticatorSelection, hints, attestation, attestationFormats, extensions);
        }
