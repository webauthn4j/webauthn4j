...
public class HMACCreateSecretExtensionAuthenticatorInput implements RegistrationExtensionAuthenticatorInput {

    public static final String ID = "hmac-secret";

    private Boolean hmacCreateSecret;

    public HMACCreateSecretExtensionAuthenticatorInput(Boolean hmacCreateSecret) {
