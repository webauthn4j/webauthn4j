...
public class HMACCreateSecretExtensionAuthenticatorOutput implements RegistrationExtensionAuthenticatorOutput {

    public static final String ID = "hmac-secret";

    private Boolean hmacCreateSecret;

    public HMACCreateSecretExtensionAuthenticatorOutput(Boolean hmacCreateSecret) {
