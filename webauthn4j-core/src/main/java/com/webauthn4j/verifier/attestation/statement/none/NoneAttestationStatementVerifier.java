...
/**
 * Verifies the specified {@link AttestationStatement} is a none attestation
 */
public class NoneAttestationStatementVerifier extends AbstractStatementVerifier<NoneAttestationStatement> {
