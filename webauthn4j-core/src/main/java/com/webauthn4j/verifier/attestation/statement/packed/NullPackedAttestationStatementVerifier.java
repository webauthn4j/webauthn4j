...
/**
 * Null verifier for {@link PackedAttestationStatement}
 */
public class NullPackedAttestationStatementVerifier extends AbstractStatementVerifier<PackedAttestationStatement> {
    @Override
