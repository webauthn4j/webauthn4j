...
public class TPMAttestationStatementVerifier extends AbstractStatementVerifier<TPMAttestationStatement> {
    ...
    public @NotNull AttestationType verify(@NotNull CoreRegistrationObject registrationObject) {
        ...
        verifyPublicKeyEquality(pubArea, authenticatorData, attestationStatement);
    ...
    private void verifyX5c(TPMAttestationStatement attestationStatement, TPMSAttest certInfo, AuthenticatorData<RegistrationExtensionAuthenticatorOutput> authenticatorData) {
        ...
        try {
            ...
            throw new BadAttestationStatementException("Failed to verify the signature.", attestationStatement, e);
        }
    ...
    String getJcaName(@NotNull TPMAttestationStatement attestationStatement) {
    ...
    private void verifyPublicKeyEquality(TPMTPublic pubArea, AuthenticatorData<RegistrationExtensionAuthenticatorOutput> authenticatorData, TPMAttestationStatement attestationStatement) {
        //noinspection ConstantConditions as null check is already done in caller
    ...
    private void verifySubjectAlternativeName(X509Certificate certificate) throws CertificateParsingException {
        ...
        catch (TPMDevicePropertyDecoder.TPMDevicePropertyDecoderException e) {
            throw new AikCertificateValidationException("Failed to decode TPM device property", e);
        }
