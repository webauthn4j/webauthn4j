...
public class WebAuthnCBORModule extends SimpleModule {
    ...
    public WebAuthnCBORModule(JsonConverter jsonConverter, CborConverter cborConverter) {
        ...
        this.addSerializer(EC2CredentialPublicKey.class, new EC2CredentialPublicKeySerializer());
        this.addSerializer(JWS.class, new JWSSerializer());
        this.addSerializer(Origin.class, new OriginSerializer());
        this.addSerializer(RSACredentialPublicKey.class, new RSACredentialPublicKeySerializer());
