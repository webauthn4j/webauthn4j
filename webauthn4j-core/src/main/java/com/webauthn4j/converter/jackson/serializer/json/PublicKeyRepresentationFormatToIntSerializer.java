...
public class PublicKeyRepresentationFormatToIntSerializer extends StdSerializer<PublicKeyRepresentationFormat> {

    public PublicKeyRepresentationFormatToIntSerializer() {
