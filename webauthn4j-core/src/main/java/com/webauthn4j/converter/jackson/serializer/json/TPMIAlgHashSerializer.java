 ...
 */
@Deprecated
public class TPMIAlgHashSerializer extends StdSerializer<TPMIAlgHash> {

    public TPMIAlgHashSerializer() {
        super(TPMIAlgHash.class);
    }

    @Override
    public void serialize(@NotNull TPMIAlgHash value, @NotNull JsonGenerator gen, @NotNull SerializationContext ctxt) {
