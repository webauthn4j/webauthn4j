...
public class AndroidSafetyNetAttestationStatementSerializer extends AbstractCtapCanonicalCborSerializer<AndroidSafetyNetAttestationStatement> {
    ...
    public AndroidSafetyNetAttestationStatementSerializer() {
        super(AndroidSafetyNetAttestationStatement.class, Arrays.asList(
                new FieldSerializationRule<>("ver", AndroidSafetyNetAttestationStatement::getVer),
                new FieldSerializationRule<>("response", AndroidSafetyNetAttestationStatement::getResponse)
        ));
    }
}
