...
public class FIDOU2FAttestationStatementSerializer extends AbstractCtapCanonicalCborSerializer<FIDOU2FAttestationStatement> {
    ...
    public FIDOU2FAttestationStatementSerializer() {
        super(FIDOU2FAttestationStatement.class, Arrays.asList(
                new FieldSerializationRule<>("sig", FIDOU2FAttestationStatement::getSig),
                new FieldSerializationRule<>("x5c", FIDOU2FAttestationStatement::getX5c)
        ));
    }
}
