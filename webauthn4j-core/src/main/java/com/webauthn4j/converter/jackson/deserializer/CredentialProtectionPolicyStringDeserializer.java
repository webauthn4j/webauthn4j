...
public class CredentialProtectionPolicyStringDeserializer extends StdDeserializer<CredentialProtectionPolicy> {
    protected CredentialProtectionPolicyStringDeserializer() {
        super(CredentialProtectionPolicy.class);
    }

    @Override
    public CredentialProtectionPolicy deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
