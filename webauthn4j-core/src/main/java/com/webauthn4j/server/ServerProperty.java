...
public class ServerProperty extends CoreServerProperty {
    ...
    static class SimpleOriginPredicate implements OriginPredicate {
    ...
    static class NoOriginPredicate implements OriginPredicate {
        @Override
        public boolean test(Origin origin) {
            return false;
        }
    ...
    static class AnyOriginPredicate implements OriginPredicate {
        @Override
        public boolean test(Origin origin) {
            return true;
        }
